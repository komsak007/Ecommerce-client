...
const ProductCardInCheckout = ({p}) => {
  ...
  const handleColorChange = e => {
    console.log("Color Chang", e.target.value);
    ...
    <tbody>
      <tr>
        ...
        <td className='text-center'>
          <input style={{width: "60px", height: "auto"}} className="form-control" type="number" value={p.count} onChange={handleQuantityChange} />
        </td>
        <td className='text-center'>
          {p.shipping === "Yes"
          ?
